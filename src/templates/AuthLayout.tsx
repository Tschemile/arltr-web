...
export default function AuthLayout(props: AuthLayoutProps) {
  return (
    <div className="flex h-[100vh] w-full items-center justify-center">
      <div className=" w-full overflow-hidden rounded-lg border border-solid shadow-lg sm:w-[65%] lg:h-[55%]">
        <div className="lg:flex lg:h-full lg:items-center lg:justify-center">
          ...
          <div className="h-full w-full px-12 py-4">{props.children}</div>
        </div>
      </div>
    </div>
  );
